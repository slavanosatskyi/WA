...
var googleAPIkey = exports.googleAPIkey = "AIzaSyCU6PzOG2JD1-1YACW7nMHT70CXZDhTq-Y";
...
var _WeatherWidget = __webpack_require__(405);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

_reactDom2.default.render(React.createElement(_WeatherWidget.WeatherWidget, null), document.querySelector('#root'));
...
exports.WeatherWidget = undefined;
...
var _reactGeocode = __webpack_require__(144);

var _reactGeocode2 = _interopRequireDefault(_reactGeocode);

var _httpService = __webpack_require__(48);

var _CitySearch = __webpack_require__(407);

var _CalendarDate = __webpack_require__(410);

var _WeatherStatus = __webpack_require__(412);

var _localtime = __webpack_require__(414);

var _common = __webpack_require__(109);
...
var WeatherWidget = exports.WeatherWidget = function (_React$Component) {
    ...
    function WeatherWidget() {
        ...
        _this.httpsService = new _httpService.HTTPService();
        _this.state = {
            condition: {},
            city: '',
            sunrise: new Date(),
        ...
        _reactGeocode2.default.setApiKey(_common.googleAPIkey);
        return _this;
    }
    ...
    _createClass(WeatherWidget, [{
        ...
        value: function componentDidMount() {
            ...
            document.addEventListener('click', function (event) {
                if (_this2.state.isAutoCompleteOpened) {
                    _this2.setState({ isAutoCompleteOpened: false });
                }
            });
        }
    }, {
        key: 'getCurrentGeolocation',
        value: function getCurrentGeolocation() {
            var _this3 = this;

            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(function (position) {
                    _this3.setCityNameFromCoodrindates(position.coords);
                }, function (error) {
                    console.log(error);
                });
            }
        ...
        key: 'setCityNameFromCoodrindates',
        value: function setCityNameFromCoodrindates(coords) {
            var _this4 = this;

            _reactGeocode2.default.fromLatLng(coords.latitude, coords.longitude).then(function (response) {
                for (var i = 0; i < response.results[0].address_components.length; ++i) {
                    if (response.results[0].address_components[i].types.includes('locality')) {
                        _this4.setState({ city: response.results[0].address_components[i].long_name });
                        _this4.fetchData();
                        break;
                    }
                }
        ...
        value: function fetchData() {
            ...
            this.httpsService.get(URL, function (data) {
                _this5.setState(function (oldState) {
                    var newState = Object.assign({}, oldState);
                    newState.condition = data.query.results.channel.item.condition;
                    _this5.setSunriseTime(data.query.results.channel.astronomy);
                    _this5.setSunsetTime(data.query.results.channel.astronomy);
                    console.log(_this5.state.sunrise);
                    console.log(_this5.state.sunset);
                    return newState;
                });
            });
            var localTime = new _localtime.LocalTime();
            localTime.getCityLocalTime(this.state.city, function (data) {
                _this5.setState(function (oldState) {
                    var d1 = new Date();
                    var timestamp = new Date(d1.getUTCFullYear(), d1.getUTCMonth(), d1.getUTCDate(), d1.getUTCHours(), d1.getUTCMinutes(), d1.getUTCSeconds());
                    console.log(data);
                    var newState = Object.assign({}, oldState);
        ...
        key: 'setSunriseTime',
        value: function setSunriseTime(astronomy) {
            var hoursAndMinutes = this.getHoursAndMinutes(astronomy.sunrise);
            this.state.sunrise.setHours(hoursAndMinutes[0]);
            this.state.sunrise.setMinutes(hoursAndMinutes[1]);
        }
    }, {
        key: 'setSunsetTime',
        value: function setSunsetTime(astronomy) {
            var hoursAndMinutes = this.getHoursAndMinutes(astronomy.sunset);
            this.state.sunset.setHours(hoursAndMinutes[0]);
            this.state.sunset.setMinutes(hoursAndMinutes[1]);
        }
    }, {
        key: 'getHoursAndMinutes',
        value: function getHoursAndMinutes(time) {
            var regexp = /\d+:\d+/;
            var found = time.match(regexp);
            if (found.size === 0) {
                return null;
            }
            var result = found[0].split(':');
            if (time.includes('pm')) {
        ...
        key: 'handleChange',
        value: function handleChange(event, isPredictionResultEmpty) {
            this.setState({
        ...
        key: 'onListItemClick',
        value: function onListItemClick(itemText) {
            this.state.city = itemText; //strange behavior here if call setState
            this.fetchData();
        }
    }, {
        key: 'isDayTime',
        value: function isDayTime() {
        ...
        value: function render() {
            return React.createElement(
                'div',
                { className: this.isDayTime() ? "weather-widget weather-widget_day" : "weather-widget" },
                React.createElement(_CitySearch.CitySearch, { value: this.state.city,
                ...
                React.createElement(
                    'div',
                    { className: 'weather-widget__date' },
                    React.createElement(_CalendarDate.CalendarDate, null)
                ),
                React.createElement(
                    'div',
                    { className: 'weather-widget__status' },
                    React.createElement(_WeatherStatus.WeatherStatus, { temperature: this.state.condition.temp,
...
var _autocompliter = __webpack_require__(408);
...
var CitySearch = exports.CitySearch = function (_React$Component) {
    _inherits(CitySearch, _React$Component);

    function CitySearch(props) {
        _classCallCheck(this, CitySearch);

        var _this = _possibleConstructorReturn(this, (CitySearch.__proto__ || Object.getPrototypeOf(CitySearch)).call(this));
    ...
    _createClass(CitySearch, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement('input', { className: 'autocomplete__input',
                    type: 'text',
                ...
                React.createElement(
                    'div',
                    { className: this.props.isAutoCompleteOpened ? "autocomplete__list autocomplete__list_visible" : "autocomplete__list" },
                    this.getListOfPredictions()
                )
            );
        }
    }, {
        key: 'getListOfPredictions',
        value: function getListOfPredictions() {
            var _this2 = this;

            var predictions = this.state.predictions.map(function (prediction, index) {
                return React.createElement(
                    'p',
                    { key: index, className: 'autocomplete__list-item', onClick: _this2.onListItemClick },
                    prediction
                );
            });
        ...
        value: function onChange(e) {
            ...
            var autocompliter = new _autocompliter.Autocompliter();
            autocompliter.getSuggestions(e.target.value, function (data) {
                var cities = [];
                data.predictions.forEach(function (prediction) {
                    cities.push(prediction.description);
                });
                _this3.setState({ predictions: cities });
            });
...
exports.Autocompliter = undefined;
...
var Autocompliter = exports.Autocompliter = function () {
    function Autocompliter() {
        _classCallCheck(this, Autocompliter);
    }

    _createClass(Autocompliter, [{
        key: 'getSuggestions',
        value: function getSuggestions(input, callback) {
            var URL = 'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=' + input + '&types=(cities)&key=' + _common.googleAPIkey;

            var service = new _httpService.HTTPService();
...
exports.CalendarDate = undefined;
...
var CalendarDate = exports.CalendarDate = function (_React$Component) {
    _inherits(CalendarDate, _React$Component);

    function CalendarDate() {
        _classCallCheck(this, CalendarDate);

        return _possibleConstructorReturn(this, (CalendarDate.__proto__ || Object.getPrototypeOf(CalendarDate)).apply(this, arguments));
    }
...
exports.WeatherStatus = undefined;
...
var WeatherStatus = exports.WeatherStatus = function (_React$Component) {
    _inherits(WeatherStatus, _React$Component);

    function WeatherStatus() {
        _classCallCheck(this, WeatherStatus);

        return _possibleConstructorReturn(this, (WeatherStatus.__proto__ || Object.getPrototypeOf(WeatherStatus)).apply(this, arguments));
    }
    ...
    _createClass(WeatherStatus, [{
        ...
        value: function getImage() {
            ...
            return React.createElement('img', { className: 'weather-status__image-wrapper_image', src: imageURl, alt: '' });
        }
    }, {
        key: 'render',
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'weather-status__header' },
                    React.createElement(
                        'div',
                        { className: 'weather-status__image-wrapper' },
                        this.getImage()
                    ),
                    React.createElement(
                        'div',
                        { className: 'weather-status__temperature' },
                        this.props.temperature
                    )
                ),
                React.createElement(
                    'div',
                    { className: 'weather-status__description' },
...
var LocalTime = exports.LocalTime = function () {
    ...
    _createClass(LocalTime, [{
        key: 'getCityLocalTime',
        value: function getCityLocalTime(city, callback) {
            this.getCityLocation(city, callback);
        }
    }, {
        key: 'getCityLocation',
        value: function getCityLocation(city, callback) {
            var _this = this;

            _reactGeocode2.default.setApiKey(_common.googleAPIkey);
            _reactGeocode2.default.fromAddress(city).then(function (response) {
                var _response$results$0$g = response.results[0].geometry.location,
                    lat = _response$results$0$g.lat,
                    lng = _response$results$0$g.lng;

                _this.requestLocalTime(lat, lng, callback);
            }, function (error) {
                console.error(error);
            });
        }
    }, {
        key: 'requestLocalTime',
        value: function requestLocalTime(lat, lng, callback) {
            var d1 = new Date();
            var timestamp = new Date(d1.getUTCFullYear(), d1.getUTCMonth(), d1.getUTCDate(), d1.getUTCHours(), d1.getUTCMinutes(), d1.getUTCSeconds()); //Date.now()/1000//Date.UTC(now.getUTCFullYear(), now.getUTCMonth(), now.getUTCDay(), now.getUTCHours(), now.getUTCMinutes(), now.getUTCSeconds())/1000;
            var URL = 'https://maps.googleapis.com/maps/api/timezone/json?location=' + lat + ',' + lng + '&timestamp=' + timestamp / 1000 + '&key=' + _common.googleAPIkey;
            var service = new _httpService.HTTPService();
            service.get(URL, function (data) {
                callback(data);
            });
